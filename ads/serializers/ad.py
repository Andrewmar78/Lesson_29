...
class AdSerializer(serializers.ModelSerializer):
    ...
    author = serializers.SlugRelatedField(required=False, queryset=queryset1, slug_field='username')
    category = serializers.SlugRelatedField(required=False, queryset=queryset2, slug_field='name')
